...
from dbm.mol_n_generator import Mol_N_Generator
from dbm.mol_n_generator_AA import Mol_N_Generator_AA
...
class DS(Dataset):
    def __init__(self, data, cfg, train=True):
        ...
        g = Mol_N_Generator(data, train=train, rand_rot=False, n_mols=self.n_mols)
    ...
    def __getitem__(self, ndx):
        ...
        energy_ndx_inp = (d['inp_bond_ndx'], d['inp_ang_ndx'], d['inp_dih_ndx'], d['inp_lj_ndx'])
        energy_ndx_out = (d['out_bond_ndx'], d['out_ang_ndx'], d['out_dih_ndx'], d['out_lj_ndx'])
...
class GAN():
    ...
    def val(self):
        ...
        g = Mol_N_Generator_AA(self.data, train=False, rand_rot=False, n_mols=n_mols)
        all_elems = list(g)
